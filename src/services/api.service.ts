...
const DELIVER_JOKES_URL = process.env.NEXT_PUBLIC_DELIVER_JOKES_URL || 'http://localhost:5000';
const SUBMIT_JOKES_URL = process.env.NEXT_PUBLIC_SUBMIT_JOKES_URL || 'http://localhost:5005';
const MODERATE_JOKES_URL = process.env.NEXT_PUBLIC_MODERATE_JOKES_URL || 'http://localhost:5001';
